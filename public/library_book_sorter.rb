puts "Enter an array (without qoutes) you want to display vertically:"
#splits the string of words into an array, then sorts it alphabetically
array = gets.split(" ").sort
puts "============="
